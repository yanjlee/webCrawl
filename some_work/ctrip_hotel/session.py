...
class makeSession(headers):
    ...
    def get_hotel_list(self, dict, n):
        try:
            ...
            #     'http': '183.184.131.222:8080',
            #     'http': '183.240.87.229:8080',
            #     'http': '61.166.151.82:8080'
            # }
            proxies = {
                'http': '123.55.126.231:38308',
    ...
    def get_hoel_info(self, hid):
        try:
            ...
            time.sleep(3)
            #这里缺一个return
            return self.__session.get(url, headers=headers, timeout=30).text
        except Exception as e:
            print(e)
            time.sleep(10)
            return False
    def get_room_info(self, hid):
        try:
            ...
            time.sleep(3)
            return self.__session.get(url, params=params, headers=headers, timeout=30).text
        except Exception as e:
            print(e)
            time.sleep(10)
            return False